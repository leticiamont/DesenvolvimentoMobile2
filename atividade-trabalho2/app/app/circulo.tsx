...
export default function Circulo() {
  ...
  const calcular = () => {
    ...
    const areaCalc = Math.PI * r * r;
    const perimetroCalc = 2 * Math.PI * r;
    setArea(areaCalc);
  ...
  const router = useRouter();
   ...
   return (
      ...
      <Image source={require('../assets/circulo.png')} style={styles.image} resizeMode="contain" />

      <View style={styles.formulas}>
        <Text style={styles.formulaText}>Área = π × r²</Text>
        <Text style={styles.formulaText}>Perímetro = 2 × π × r</Text>
      </View>
